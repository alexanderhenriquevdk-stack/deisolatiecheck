...
export const metadata = {
  ...
  keywords:
    "isolatie subsidie, ISDE subsidie 2026, dakisolatie subsidie, vloerisolatie subsidie, spouwmuurisolatie, huis isoleren kosten, subsidie aanvragen isolatie, woningisolatie, isolatie check",
  openGraph: {
    title: "De Isolatie Check | Bereken je ISDE subsidie 2026",
    description:
